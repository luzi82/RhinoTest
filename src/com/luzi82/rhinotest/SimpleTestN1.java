...
public class SimpleTestN1 {
	...
	public void test0() throws FileNotFoundException, IOException {
		...
		Assert.assertEquals(800f, (double) sa.get("width", sa), 0.0001);
		Assert.assertEquals(600f, (double) sa.get("height", sa), 0.0001);
	...
	public void test1() throws FileNotFoundException, IOException {
		...
		Scriptable sa = (Scriptable) result;
		Assert.assertEquals(800d, (double) ((Callable) sa.get("width", sa))
				.call(cx, scope, null, new Object[0]), .0001);
		Assert.assertEquals(600d, (double) ((Callable) sa.get("height", sa))
				.call(cx, scope, null, new Object[0]), .0001);
		Assert.assertEquals("#ff7f7f7f", ((Callable) sa.get("backgroundColor",
				sa)).call(cx, scope, null, new Object[0]));
		Assert.assertEquals(800d, (double) ((Callable) sa.get("extra", sa))
				.call(cx, scope, null, new Object[0]), .0001);
	...
	public void test2() throws FileNotFoundException, IOException {
		...
		Scriptable sa = (Scriptable) result;
		Assert.assertEquals(800d, (double)sa.get("width", sa),.0001);
		Assert.assertEquals(600d, (double)sa.get("height", sa),.0001);
		Assert.assertEquals(800d, (double)sa.get("extra", sa),.0001);
